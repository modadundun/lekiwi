...
class KeyboardTeleopConfig(TeleoperatorConfig):
    ...
    # LeKiwi keyboard teleop parameters
    arm_delta: float = 15.0  # Arm position increment per key press (in normalized units [-100, 100])
    linear_speed: float = 0.5  # Base linear velocity (m/s)
    angular_speed: float = 1.0  # Base angular velocity (rad/s)
    strafe_speed: float = 0.3  # Base strafe velocity (m/s)
