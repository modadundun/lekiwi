...
def move_cursor_up(lines):
    """Move the cursor up by a specified number of lines and clear them for fresh output."""
    # Move cursor up N lines, return to column 0, clear the rest of the line
    print(f"\033[{lines}A\033[0G\033[K", end="")
