...
class LeKiwi(Robot):
    ...
    def __init__(self, config: LeKiwiConfig):
        ...
        self.bus = FeetechMotorsBus(
            ...
            motors={
                ...
                # right arm (IDs 21-25) + gripper (ID 26)
                "arm_right_shoulder_pan": Motor(21, "sts3215", norm_mode_body),
                "arm_right_shoulder_lift": Motor(22, "sts3215", norm_mode_body),
                "arm_right_elbow_flex": Motor(23, "sts3215", norm_mode_body),
                "arm_right_wrist_flex": Motor(24, "sts3215", norm_mode_body),
                "arm_right_wrist_roll": Motor(25, "sts3215", norm_mode_body),
                "arm_right_gripper": Motor(26, "sts3215", norm_mode_body),
                # base (IDs 7-9)
    ...
    def send_action(self, action: RobotAction) -> RobotAction:
        ...
        arm_speed_raw = {motor: 1100 for motor in self.arm_motors}
